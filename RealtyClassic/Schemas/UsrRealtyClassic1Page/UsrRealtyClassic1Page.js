define("UsrRealtyClassic1Page", ["ServiceHelper"], function(ServiceHelper) {
	return {
		...
		diff: /**SCHEMA_DIFF*/[
			{
				"operation": "insert",
				"name": "UsrName5d913826-bf6b-4c81-827a-c91887874806",
				"values": {
					"layout": {
						"colSpan": 24,
						"rowSpan": 1,
			...
			{
				"operation": "insert",
				"name": "FLOATf64f2075-8d32-4110-8110-778abb46fd9b",
				"values": {
					"layout": {
						"colSpan": 24,
						"rowSpan": 1,
			...
			{
				"operation": "insert",
				"name": "FLOATc0743817-d782-4d27-a59f-02ffc92a0890",
				"values": {
					"layout": {
						"colSpan": 24,
						"rowSpan": 1,
			...
			{
				"operation": "insert",
				"name": "LOOKUPba16dc4e-748e-4f88-93c3-31f1ac9402d8",
				"values": {
					"layout": {
						"colSpan": 12,
						"rowSpan": 1,
			...
			{
				"operation": "insert",
				"name": "LOOKUPd9e99b39-8ff1-4d20-9dbe-87f1c2f71db4",
				"values": {
					"layout": {
						"colSpan": 12,
						"rowSpan": 1,
